                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`py-3 rounded-lg text-sm font-bold tracking-widest flex flex-col items-center justify-center transition-colors border ${isPast
                                                                ...
                                                                : 'bg-[#252528] border-white/10 text-white hover:border-[#e50914] hover:bg-[#e50914]/10 active:scale-95'
                                                            }`}
                                                    >
                    ...
                    <div className="bg-[#18181b] border border-white/10 rounded-2xl w-full max-w-md p-8 shadow-2xl animate-in zoom-in-95">
                        ...
                        <div className="flex flex-col gap-3">
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-[#e50914] to-[#c0000c] text-white py-4.5 rounded-xl font-bold uppercase tracking-widest text-xs transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
                            >
