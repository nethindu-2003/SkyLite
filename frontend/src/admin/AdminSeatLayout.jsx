                    ...
                    <div className="bg-[#18181b] border border-white/5 rounded-3xl p-8 shadow-2xl">
                        ...
                        <div className="pt-8 mt-8 border-t border-white/5">
                            <button
                                ...
                                className="w-full bg-[#e50914] hover:bg-[#c0000c] text-white py-4 rounded-xl font-bold uppercase tracking-widest text-xs transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2 shadow-[0_10px_20px_rgba(229,9,20,0.3)]"
                            >
