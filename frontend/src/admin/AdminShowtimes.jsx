...
export default function AdminShowtimes() {
 ...
 className="group relative rounded-2xl overflow-hidden bg-[#18181b] border border-white/10 cursor-pointer hover:border-[#e50914] transition-all shadow-lg hover:shadow-[0_10px_30px_rgba(229,9,20,0.3)] "
 >
