            ...
            {activeTab === 'profile' && (
              <div className="animate-in fade-in duration-500">
                ...
                <form onSubmit={handleProfileUpdate} className="space-y-6">
                  ...
                  <div className="pt-6">
                    <button disabled={actionLoading} type="submit" className="w-full sm:w-auto bg-[#e50914] text-white px-10 py-4 rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-[#c0000c] transition-colors active:scale-95 shadow-lg disabled:opacity-50">
            ...
            {activeTab === 'security' && (
              <div className="animate-in fade-in duration-500">
                ...
                <form onSubmit={handlePasswordUpdate} className="space-y-6">
                  ...
                  <div className="pt-6">
                    <button disabled={actionLoading} type="submit" className="w-full sm:w-auto bg-[#e9c349] text-black px-10 py-4 rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-[#d4ac31] transition-colors active:scale-95 shadow-lg disabled:opacity-50">
                    ...
                    {bookings.upcoming.length === 0 ? (
                      ...
                      bookings.upcoming.map(ticket => (
                        ...
                        >
                          ...
                          <div className="bg-[#e50914] text-white px-6 py-3 rounded-lg text-[10px] font-bold uppercase tracking-widest flex items-center gap-2 group-hover:scale-105 transition-transform shadow-lg">
