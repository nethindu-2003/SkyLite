...
const AboutUs = () => {
 return (
 <div className="bg-[#131314] text-white">
 ...
 <p className="text-base md:text-lg text-zinc-300 leading-relaxed font-body max-w-2xl">
 ...
 >
 <div className="w-14 h-14 rounded-xl bg-[#e50914]/10 flex items-center justify-center mb-6 transition-transform">
 <span className="material-symbols-outlined text-[#e50914] text-3xl">visibility</span>
 </div>
 <h2 className="text-2xl md:text-3xl font-headline font-bold text-white uppercase tracking-wider mb-4">Our Vision</h2>
 <p className="text-base md:text-lg text-zinc-300 leading-relaxed font-body">
 ...
 <h2 className="text-2xl md:text-3xl font-headline font-bold text-white uppercase tracking-wider mb-4">Our Mission</h2>
 <p className="text-base md:text-lg text-zinc-300 leading-relaxed font-body">
 ...
 <h2 className="text-2xl md:text-3xl font-headline font-bold text-white uppercase tracking-wider mb-8">Experience Matara's Finest</h2>
 <p className="text-base md:text-lg text-zinc-300 leading-relaxed font-body mb-6">
